...
export declare class RevokeRight extends SignableOperation {
    private readonly did;
    private readonly lastTxId;
    private readonly auth;
    private readonly right;
    constructor(did: Did, lastTxId: Sdk.TransactionId | null, auth: Crypto.Authentication, right: Sdk.Right);
