...
export interface IApi {
    ...
    */
    ...
    sendMorpheusTx(senderAddress: string, morpheusAsset: IMorpheusAsset, hydraPrivate: HydraPrivate, nonce?: bigint): Promise<string>;
    /**
    * @deprecated This method is deprecated in favor of sendMorpheusTx()
    */
    sendMorpheusTxWithWIF(attempts: IOperationData[], fromWIF: string, nonce?: bigint): Promise<string>;
    /**
    * @deprecated This method is deprecated in favor of sendMorpheusTx()
    */
    sendMorpheusTxWithPassphrase(attempts: IOperationData[], passphrase: string, nonce?: bigint): Promise<string>;
